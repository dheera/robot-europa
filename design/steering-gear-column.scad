...
spur_gear (modul=3.8, tooth_number=32, width=12, bohrung=2.3*25.4, pressure_angle=20, schraegungswinkel=0, optimized=false);
    
        /*translate([0,0,10])
        difference() {
        cylinder(d=25.4*3.6,h=17,$fn=256);
            cylinder(d=25.4*2.3,h=20,$fn=256);
        }*/
  ...
  cylinder(d=1/8*25.4+.2,h=50,$fn=32);
    }
}
}
